...
// const checkbox = document.getElementById("view-checkbox");
// checkbox.addEventListener("click", toggleViewPassword);

// function toggleViewPassword(selector) {
//     const inputNode =
//         document.getElementById(selector).parentElement.childNodes[1];
...
const buttonViewConfirmPassword = document.querySelector(
...
buttonViewConfirmPassword.addEventListener("click", () =>
    toggleViewPassword(".view-confirm_password")
);

function toggleViewPassword(selector) {
    const inputNode =
        document.querySelector(selector).parentElement.childNodes[1];
