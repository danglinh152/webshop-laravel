            ...
            <form action="{{ URL::to('/admin/product/save-product') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 gap-x-6 sm:grid-cols-6 w-3/5 mx-auto">
                            ...
                            <div class="text-center">
                                ...
                                <div class="flex text-sm leading-6 text-gray-600 ">
                                    <label for="fileUpload"
                                        class="relative cursor-pointer rounded-md bg-white font-semibold text-blue-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-blue-800 focus-within:ring-offset-2 hover:text-blue-800">
                    ...
                    <div class="sm:col-span-full mt-4">
                        ...
                        <a href="{{ URL::to('/admin/product') }}" type="submit"
