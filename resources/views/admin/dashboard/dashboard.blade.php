...
<main class="h-full overflow-y-auto">
    <div class="container px-6 mx-auto grid">
        ...
        <!-- Video Section -->
        <div class="mb-6">
            <iframe width="100%" height="315" src="https://www.youtube.com/embed/IzSYlr3VI1A?si=SyLhxNlHeMzKbHk2&autoplay=1&mute=1"
        ...
        <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
            <!-- Card -->
            <div class="flex items-center p-4 bg-white rounded-lg shadow-lg transition-transform transform hover:scale-105">
