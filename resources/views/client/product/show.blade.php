        ...
        <div class="container">
            <div class="tab-class">
                <div class="row justify-content-between">
                    ...
                    <div class="input-group w-25 mx-auto d-flex">
                        <input type="search" class="form-control py-1 px-3" placeholder="Nhập tên sản phẩm"
                            aria-describedby="search-icon-1">
                        <span id="search-icon-1" class="input-group-text py-1"><i class="fa fa-search"></i></span>
                    </div>
                </div>
