                         ...
                         @foreach ($get_product as $key => $get_product)
                             ...
                             <div class="col-lg-6">
                                 ...
                                 <h5 class="fw-bold mb-3">
                                     <?php $formatted_price = number_format($get_product->product_price);
                                 ...
                                 <div class="row g-4">
                                     ...
                                     <div class="col-lg-12">
                                         <div class="border-bottom rounded my-4">
                                             <textarea name="review_content" id="" class="form-control border-0" cols="30" rows="8"
                                         ...
                                         <div class="d-flex justify-content-between py-3 mb-5">
                                             <div class="d-flex align-items-center">
                                                 ...
                                                 <div id="rating" class="d-flex align-items-center">
                                                     ...
                                                     <svg class="me-1" style="width: 16px; height: 16px; color: #E4E4E4;"
                                                     ...
                                                     <svg class="me-1"
                                                         style="width: 16px; height: 16px; color: #E4E4E4;"
                                                         aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                                         fill="currentColor" viewBox="0 0 22 20">
                                                         <path
                                                             d="M20.924 7.625a1.523 1.523 0 0 0-1.238-1.044l-5.051-.734-2.259-4.577a1.534 1.534 0 0 0-2.752 0L7.365 5.847l-5.051.734A1.535 1.535 0 0 0 1.463 9.2l3.656 3.563-.863 5.031a1.532 1.532 0 0 0 2.226 1.616L11 17.033l4.518 2.375a1.534 1.534 0 0 0 2.226-1.617l-.863-5.03L20.537 9.2a1.523 1.523 0 0 0 .387-1.575Z" />
